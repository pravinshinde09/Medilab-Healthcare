    ...
    <div className="container px-xl-50">
      <div className="row">
        <div className="col-md-6">
          ...
          <p className="text-justify">
            We consider superior manufacturing to be truly critical for
            success. We strive to meet and exceed regulatory standards to
            deliver products that are consistently of higher quality. We build
            lasting partnerships on a foundation of reliability, integrity,
